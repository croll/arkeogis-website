		...
		<div class="platform-block">
			...
			<div class="specs-container">
				...
				<div class="spec">
					...
					<a href="<?php the_permalink(pll_get_post(885));?>" title="<?php pll_e("Cartographie Interactive");?>"></a>
				</div>
				<div class="spec">
					<h3>
					...
					<a href="<?php the_permalink(pll_get_post(7061));?>" title="<?php pll_e("Exportation Normalisée");?>"></a>
				</div>
				<div class="spec">
					<h3>
					...
					<a href="<?php the_permalink(pll_get_post(878));?>" title="<?php pll_e("Personnaliser");?>"></a>
				</div>
				<div class="spec">
					<h3>
						<?php pll_e("Diffuser");?>
					...
					<a href="<?php the_permalink(pll_get_post(7079));?>" title="<?php pll_e("Diffuser");?>"></a>
				</div>
				<div class="spec">
					<h3>
					...
					<a href="<?php the_permalink(pll_get_post(1075));?>" title="<?php pll_e("Pérenniser");?>"></a>
				</div>
			</div>
		</div>
				...
				<div class="swiper-wrapper">
					...
					?>
						<div class="slide swiper-slide">
							<div class="container">
								<a href="<?php the_permalink(pll_get_post(36));?>" title="<?php echo $n->title;?>" data-id="<?php echo $n->id;?>">
